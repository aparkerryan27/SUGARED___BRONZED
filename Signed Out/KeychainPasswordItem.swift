...
struct KeychainConfiguration { //A simple struct that defines the service and access group to be used by the sample apps.
    static let serviceName = "S+B"
    static let accessGroup: String? = nil
}

import Foundation

struct KeychainPasswordItem { //A struct for accessing generic password keychain items.
    // MARK: Types
    ...
    mutating func renameAccount(_ newAccountEmail: String) throws {
        // Try to update an existing item with the new account name.
        var attributesToUpdate = [String : AnyObject]()
        attributesToUpdate[kSecAttrAccount as String] = newAccountEmail as AnyObject?
